...
public class UtilisateurDAOTest extends AbstractAnnotationTest {
	...
	public void ComparateurUtil() throws Exception {
		Utilisateur comparateurUtil = this.dao.save(this.createUtilisateur());
		Utilisateur comparateurUtilDeux = this.dao.save(this.createUtilisateur());
		Assert.assertEquals("verifique qu'il n'y a pas deux utilisateur identique", comparateurUtil.getNom(),
